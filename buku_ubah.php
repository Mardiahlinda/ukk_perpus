       ...
       <form method="post">
           ...
           $id = $_GET['id'];
               if(isset($_POST['submit'])) {
                   ...
                   $judul = $_POST['judul'];
                   $penuis = $_POST['penulis'];
                   $penerbit = $_POST['penerbit'];
                   $tahun_terbit = $_POST['tahun_terbit'];
                   $deskripsi = $_POST['deskripsi'];
                   $query = mysqli_query($koneksi, "UPDATE buku SET id_kategori='$id_kategori', judul='$judul', penulis='$penulis',
                 ...
                 <div class="col=md-8">
                     <select name="id_kategori" class="form-control">
                         <?php
                             ...
                             while($kategori_buku = mysqli_fetch_array($kat)) {
                                 ?>
                                 <option <?php if($kategori_buku['id_kategori'] ==$data['id_kategori']) echo 'selected'; ?>
                                 value="<?php echo $kategori_buku['id_kategori']; ?>"><?php echo $kategori_buku['kategori']; ?></option>
                                 <?php
                               }
                         ?>
                     </select>
                  ...
                  <div class="col-md-8"><input type="text" value="<?php echo $data['deskripsi']; ?>" class="form-control" name="deskipsi"></div>
            </div>
            </div>
            <div class="row">
